...
Vue.component('chat', {
  ...
  mounted: function () {
    if (typeof this.task === "undefined") {
      ...
      this.api_url = '/api/messages/task/' + this.task;
  ...
  methods: {
    sendMessage: function () {
      ...
      fetch(this.api_url, {
        ...
        body: JSON.stringify({sender: this.sender, recipient: this.recipient, message: this.message, task_id: this.task})
      })
        .then(result => {
