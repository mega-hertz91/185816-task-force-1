    ...
    <div class="main-container page-container">
        <section class="menu-toggle">
            <?php echo Menu::widget([
                'options' => ['class' => 'menu-toggle__list'],
                'itemOptions' => ['class' => 'menu-toggle__item'],
                'activeCssClass' => 'menu_toggle__item--current',
                'items' => [
                    ['label' => 'Завершенные', 'url' => ['cabinet/tasks/complete'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--completed'], 'template' => '<div class="menu-toggle__svg-wrapper">
                    ...
                    ['label' => 'Новые', 'url' => ['cabinet/tasks/new'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--new'], 'template' => '<div class="menu-toggle__svg-wrapper">
                    ...
                    ['label' => 'Активные', 'url' => ['cabinet/tasks/active'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--active'], 'template' => '<div class="menu-toggle__svg-wrapper">
                    ...
                    ['label' => 'Просроченные', 'url' => ['cabinet/tasks/overdue'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--hidden'], 'template' => '<div class="menu-toggle__svg-wrapper">
                       <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="feedback-card__top ">
                            ...
                            <div class="feedback-card__top--name my-list__bottom">
                                ...
                                <?php for ($i = 0; $i < $task->user::MAX_RATING; $i++): ?>
                                    <?php if ($task->user->rating > $i): ?>
                                        <span></span>
                                    <?php else: ?>
                                        <span class="star-disabled"></span>
                                    <?php endif; ?>
                                <?php endfor; ?>
                                <b><?= $task->user->rating ?></b>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
